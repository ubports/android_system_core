...
static const struct fs_path_config android_dirs[] = {
    ...
    { 00755, AID_ROOT,   AID_SHELL,  0, "system/ext" },
...
static const struct fs_path_config android_files[] = {
    ...
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/bin/*" },
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/ext/linker" },
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/ext/camera_service" },
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/ext/camera_service.wrapper" },
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/ext/mm-qcamera-daemon" },
    { 00755, AID_ROOT,      AID_SHELL,     0, "system/ext/mm-qcamera-daemon.wrapper" },
